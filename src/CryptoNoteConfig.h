...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xaf;
...
const char     CRYPTONOTE_NAME[]                             = "WegCoin";
...
const int      P2P_DEFAULT_PORT                              = 18325;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18425;
